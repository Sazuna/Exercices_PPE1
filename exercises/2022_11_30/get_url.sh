...
do
	...
	echo "count : $COUNT"
	echo "$OUTPUT_NUMBER, $CODE, <a href=\"$URL\">$URL</a>, <a href=\"$ASPIRATION_F\">HTML aspiré</a>, <a href=\"$DUMP_F\">Texte aspiré</a>, $COUNT, <a href=\"$CONTEXT_F\">Contexte</a>, <a href=\"$CONCORDANCES_F\">Concordance</a>" >> $CSV
